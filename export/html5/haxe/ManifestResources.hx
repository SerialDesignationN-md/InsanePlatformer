...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_level_csv extends null { }
...
@:keep @:file("assets/level.csv") @:noCompletion #if display private #end class __ASSET__assets_level_csv extends haxe.io.Bytes {}
