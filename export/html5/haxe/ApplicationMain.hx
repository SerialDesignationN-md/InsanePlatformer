...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("EZPlatformer", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("EZPlatformer", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "EZPlatformer";
		app.meta["name"] = "EZPlatformer";
